...
<div class="">
  <header class="navbar navbar-expand-sm navbar-light d-print-none">
    <div class="container-xl">
      ...
      <div class="nav-item">
        <a href="{{ url('/login/masyarakat') }}" class="btn btn-primary">Login</a>
      </div>
    </div>
  </header> 
</div>
    ...
    <div class="container-xl">
      ...
      <div class="nav-item dropdown">
        <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
          <span class="avatar avatar-sm"><img style="border-radius: 5px;" src="{{ asset('img/kwr.jpg') }}" alt=""></span>
          {{-- <span class="avatar avatar-sm" style="background-image: url('img/kwr.jpg')"><img src="{{ asset('img/kwr.jpg') }}" alt=""></span> --}}
          <div class="d-none d-xl-block ps-2">
            <div class="fw-bold">{{ session('id')['nama'] }}</div>
            <div class="mt-1 small text-muted">{{ session('id')['email'] }}</div>
          </div>
        </a>
        <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
          ...
          <span class="mx-2">Profil Anda</span>
          </a>
          <div class="dropdown-divider"></div>
          <a href="{{ url('logout/masyarakat') }}" class="dropdown-item">
      ...
      <div class="navbar navbar-light">
        <div class="container-xl justify-content-center">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link" href="{{ url('historipengaduan/masyarakat') }}" >
