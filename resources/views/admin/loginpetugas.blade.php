            ...
            <div class="card-body">
              ...
              <form action="./" method="get" autocomplete="off" novalidate>
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" placeholder="username anda" autocomplete="off">
                </div>
                <div class="mb-2">
                  ...
                  <div class="input-group input-group-flat">
                    <input type="password" class="form-control"  placeholder="Masukkan Kata Sandi Anda"  autocomplete="off">
